...
void verificar_Divisibilidade(void){
    ...
    if(divisivel){
        printf("\nO numero %d eh divisivel por %d",numero_01,numero_02);
    } else {
        printf("\nO numero %d NAO eh divisivel por %d",numero_01,numero_02);
    }
...
void verificar_Multiplo(void){
    ...
    if(multiplo){
        printf("\nO numero %d eh multiplo por %d",numero_01,numero_02);
    } else {
        printf("\nO numero %d NAO eh multiplo por %d",numero_01,numero_02);
    }
...
void mudanca_Base(void){
    ...
    printf("\nDigite os valor desejados: ");
    scanf("%x", &numero_01);
    printf("\nO numero %x eh na base 10 eh %d",numero_01, numero_01);
}
...
void tabela_verdadeDecimal(void){
    ...
    if (resultado[0]){
        printf("\n%d AND %d eh verdadeiro",numero_01,numero_02);
    } else {
        printf("\n%d AND %d eh falso",numero_01,numero_02);
    }

    if (resultado[1]){
        printf("\n%d OR %d eh verdadeiro",numero_01,numero_02);
    } else {
        printf("\n%d OR %d eh falso",numero_01,numero_02);
    }
    
    if (resultado[2]){
        printf("\n%d XOR %d eh verdadeiro",numero_01,numero_02);
    } else {
        printf("\n%d XOR %d eh falso",numero_01,numero_02);
    }
